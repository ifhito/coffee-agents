# Coffee Recommender Bot - Agent Guide
...
## Plan Mode Rules
- Plan modeで作成したplanは、必ず `./plan/` ディレクトリ配下に保存する
- `./plan/` が存在しない場合は先に作成してから保存する
- planファイル名は内容が判別しやすい形式（例: `2026-03-05-feature-x-plan.md`）にする
